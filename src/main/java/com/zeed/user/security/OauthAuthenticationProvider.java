...
import com.zeed.user.security.providers.IsmsUserAuthenticationProvider;
...
public class OauthAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    private IsmsUserAuthenticationProvider ismsUserAuthenticationProvider;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        authenticationProviders.add(ismsUserAuthenticationProvider);
